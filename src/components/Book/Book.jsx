            ...
            <div className='p-6'>
                ...
                <div className="space-y-3 mt-7">
                    <div className='flex gap-3'>
                        {
                            tags.map(tag => <button className="btn btn-xs bg-green-50 border-none rounded-full text-green-500 font-bold">{tag}</button>)
                        }
                    </div>
                    ...
                    <div className="card-actions pt-2 justify-between font-semibold text-gray-600">
